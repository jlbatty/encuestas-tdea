/**
 * Script de seed: carga la encuesta real en Firestore.
...
async function seed() {
  console.log('Cargando encuesta en Firestore...');
  await db.collection('encuestas').doc('encuesta-ia-2026').set(ENCUESTA_IA);
  console.log('✅ Encuesta cargada correctamente en la colección "encuestas"');
  process.exit(0);
}
